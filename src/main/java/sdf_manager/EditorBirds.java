...
public class EditorBirds extends javax.swing.JFrame {
   ...
   private void populateCategory() {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorBirds.java"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jLabel1.setIcon(new ImageIcon(p.getProperty("jLabel6.icon"))); // NOI18N
        ...
        txtGroupName.setFont(new Font(p.getProperty("txtGroupName.font"), 12, 18)); // NOI18N
        txtGroupName.setText(p.getProperty("txtGroupName.text")); // NOI18N
        ...
        jLabel12.setIcon(new ImageIcon(p.getProperty("jLabel17.icon"))); // NOI18N
