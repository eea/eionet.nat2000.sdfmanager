...
public class EditorDesignationType extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorDesignationType.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jLabel14.setIcon(new ImageIcon(p.getProperty("jLabel14.icon"))); // NOI18N
        jLabel14.setText(p.getProperty("jLabel14.text")); // NOI18N
        jLabel14.setName("jLabel14"); // NOI18N

        txtCover.setText(p.getProperty("txtCover.text")); // NOI18N
