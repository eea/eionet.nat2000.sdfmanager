...
public class EditorInternationalRelation extends javax.swing.JFrame {
    ...
    private final static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(EditorInternationalRelation.class .getName());
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorInternationalRelation.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jLabel1.setIcon(new ImageIcon(p.getProperty("jLabel4.icon"))); // NOI18N
        ...
        jLabel5.setIcon(new ImageIcon(p.getProperty("jLabel4.icon"))); // NOI18N
        jLabel5.setText(p.getProperty("jLabel5.text")); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N

        jLabel6.setIcon(new ImageIcon(p.getProperty("jLabel4.icon"))); // NOI18N
