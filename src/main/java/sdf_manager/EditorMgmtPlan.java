...
public class EditorMgmtPlan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorMgmtPlan.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        txtURL.setBorder(javax.swing.BorderFactory.createTitledBorder(p.getProperty("txtURL.border.title"))); // NOI18N
        ...
        jLabel4.setIcon(SDF_Util.getIconForLabel(p, "jLabel4.icon", SDF_ManagerApp.getMode()));
