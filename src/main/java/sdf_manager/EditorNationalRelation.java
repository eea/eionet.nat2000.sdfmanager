...
public class EditorNationalRelation extends javax.swing.JFrame {
    ...
    private final static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(EditorNationalRelation.class .getName());
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorNationalRelation.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jLabel2.setIcon(new ImageIcon(p.getProperty("jLabel6.icon"))); // NOI18N
        jLabel2.setText(p.getProperty("jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N

        jLabel4.setIcon(new ImageIcon(p.getProperty("jLabel6.icon"))); // NOI18N
        jLabel4.setText(p.getProperty("jLabel4.text")); // NOI18N
        jLabel4.setName("jLabel4"); // NOI18N

        jLabel5.setIcon(new ImageIcon(p.getProperty("jLabel6.icon"))); // NOI18N
        ...
        jLabel7.setIcon(SDF_Util.getIconForLabel(p, "jLabel7.icon", SDF_ManagerApp.getMode()));
