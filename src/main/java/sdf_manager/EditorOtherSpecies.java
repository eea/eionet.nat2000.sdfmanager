 ...
 /**
   ...
   private void populateSpeciesGroup() {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorOtherSpecies.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        chkMotivationAnnexIV.setText(p.getProperty("chkMotivationAnnexIV.text")); // NOI18N
        ...
        chkMotivationAnnexV.setText(p.getProperty("chkMotivationAnnexV.text")); // NOI18N
