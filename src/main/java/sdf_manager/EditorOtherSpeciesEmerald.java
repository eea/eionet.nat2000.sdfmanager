   ...
   private void populateSpeciesGroup() {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap =
                ...
                .getResourceMap(EditorOtherSpeciesEmerald.class);
        ...
        chkMotivationAnnexI.setText(resourceMap.getString("chkMotivationAnnexI.text")); // NOI18N
        chkMotivationAnnexI.setName("chkMotivationAnnexI"); // NOI18N

        chkMotivationAnnexII.setText(resourceMap.getString("chkMotivationAnnexII.text")); // NOI18N
        chkMotivationAnnexII.setName("chkMotivationAnnexII"); // NOI18N

        chkMotivationAnnexIII.setText(resourceMap.getString("chkMotivationAnnexIII.text")); // NOI18N
