...
/**
 * Special layout for editing other species in emerald mode.
 * @author Kaido Laine
 */
public class EditorOtherSpeciesEmerald extends javax.swing.JFrame implements IEditorOtherSpecies {
     ...
     * @param parent
     */
    public EditorOtherSpeciesEmerald(SDFEditor parent) {
        this.parent = parent;
        initComponents();
    ...
    private void loadSpecieses(String speciesCode) {
       EditorOtherSpeciesEmerald.log.info("Loading species from reference table to fill the drop down list.");
       ...
       try {
	       ...
	       EditorOtherSpeciesEmerald.log.info("Loading species group: " + (String) this.cmbGroup.getSelectedItem());
	       String groupSpecies = "-";
    ...
    void loadSpecies(OtherSpecies s, int index) {
       EditorOtherSpeciesEmerald.log.info("Loading the data of the other species.::" + s.getOtherSpeciesGroup());
       EditorOtherSpeciesEmerald.log.info("Loading the data of the other species.::" + s.getOtherSpeciesCode());
       this.editing = true;
       this.index = index;
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
	       ...
	       StringTokenizer st2 = new StringTokenizer(strMotivation, ",");
	        ...
	        while (st2.hasMoreElements()) {
	           ...
	           if (("I").equals(mot)) {
	             this.chkMotivationAnnexI.setSelected(true);
	           }
	           if (("II").equals(mot)) {
   ...
   private void saveSpecies() {
        EditorOtherSpeciesEmerald.log.info("Saving the other species");
        ...
        if (this.chkMotivationAnnexI.isSelected()) {
            motivation.append("I,");
        }
        if (this.chkMotivationAnnexII.isSelected()) {
            motivation.append("II,");
        }
        if (this.chkMotivationAnnexIII.isSelected()) {
            motivation.append("III,");
        }
   ...
   private void printSpecies(OtherSpecies s) {
       EditorOtherSpeciesEmerald.log.info("Code: " + s.getOtherSpeciesCode());
       EditorOtherSpeciesEmerald.log.info("Name: " + s.getOtherSpeciesName());
       EditorOtherSpeciesEmerald.log.info("Group: " + s.getOtherSpeciesGroup());
       EditorOtherSpeciesEmerald.log.info("Sensitve: " + s.getOtherSpeciesSensitive());
       EditorOtherSpeciesEmerald.log.info("NP: " + s.getOtherSpeciesNp());
       EditorOtherSpeciesEmerald.log.info("Size min: " + s.getOtherSpeciesSizeMin());
       EditorOtherSpeciesEmerald.log.info("Size max: " + s.getOtherSpeciesSizeMax());
       EditorOtherSpeciesEmerald.log.info("Unit: " + s.getOtherSpeciesUnit());
       EditorOtherSpeciesEmerald.log.info("Category: " + s.getOtherSpeciesCategory());
       EditorOtherSpeciesEmerald.log.info("Motivation: " + s.getOtherSpeciesMotivation());
 ...
 /**
   ...
   private String getUnitTypeNameByCode(String unitCode) {
       EditorOtherSpeciesEmerald.log.info("Getting the unit name by code");
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
   ...
   private String getUnitTypeCodeByName(String unitName) {
       EditorOtherSpeciesEmerald.log.info("Getting the unit code by name");
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
   ...
   private String getCategoryNameByCode(String categoryCode) {
       EditorOtherSpeciesEmerald.log.info("Getting the category type name by code");
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
   ...
   private String getCategoryCodeByName(String categoryName) {
       EditorOtherSpeciesEmerald.log.info("Getting the category type code by name");
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
   ...
   private String getGroupSpCodeByGroupSpName(String groupSpName) {
       EditorOtherSpeciesEmerald.log.info("Get group of species code by group of species name");
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
   ...
   private String getGroupSpNameByGroupSpCode(String groupSpCode) {
       EditorOtherSpeciesEmerald.log.info("Get group of species name by quality code");
       Session session = HibernateUtil.getSessionFactory().openSession();
       try {
   ...
   private void populateUnit() {
       EditorOtherSpeciesEmerald.log.info("Populate unit data");
   ...
   private void populateCategory() {
       EditorOtherSpeciesEmerald.log.info("Populate category data");
   ...
   private void populateSpeciesGroup() {
       EditorOtherSpeciesEmerald.log.info("Populate species group");
    ...
    private void initComponents() {
        ...
        chkMotivationAnnexI = new javax.swing.JCheckBox();
        chkMotivationAnnexII = new javax.swing.JCheckBox();
        chkMotivationAnnexIII = new javax.swing.JCheckBox();
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorOtherSpeciesEmerald.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jLabel12.setIcon(new ImageIcon(p.getProperty("jLabel4.icon"))); // NOI18N
        jLabel12.setText(p.getProperty("jLabel12.text")); // NOI18N
        jLabel12.setName("jLabel12"); // NOI18N

        txtName.setEditable(false);
        txtName.setText(p.getProperty("txtName.text")); // NOI18N
        txtName.setName("txtName"); // NOI18N

        jLabel4.setIcon(new ImageIcon(p.getProperty("jLabel4.icon"))); // NOI18N
        jLabel4.setText(p.getProperty("jLabel4.text")); // NOI18N
        jLabel4.setName("jLabel4"); // NOI18N

        chkSensitive.setText(p.getProperty("chkSensitive.text")); // NOI18N
        ...
        jLabel2.setIcon(new ImageIcon(p.getProperty("jLabel16.icon"))); // NOI18N
        jLabel2.setText(p.getProperty("jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N

        jLabel14.setIcon(new ImageIcon(p.getProperty("jLabel16.icon"))); // NOI18N
        jLabel14.setText(p.getProperty("jLabel14.text")); // NOI18N
        jLabel14.setName("jLabel14"); // NOI18N

        txtMinimum.setText(p.getProperty("txtMinimum.text")); // NOI18N
        txtMinimum.setName("txtMinimum"); // NOI18N

        txtMaximum.setName("txtMaximum"); // NOI18N

        jLabel15.setIcon(new ImageIcon(p.getProperty("jLabel16.icon"))); // NOI18N
        ...
        jLabel8.setIcon(new ImageIcon(p.getProperty("jLabel8.icon"))); // NOI18N
        ...
        chkMotivationAnnexI.setText(p.getProperty("chkMotivationAnnexI.text")); // NOI18N
        chkMotivationAnnexI.setName("chkMotivationAnnexI"); // NOI18N

        chkMotivationAnnexII.setText(p.getProperty("chkMotivationAnnexII.text")); // NOI18N
        chkMotivationAnnexII.setName("chkMotivationAnnexII"); // NOI18N

        chkMotivationAnnexIII.setText(p.getProperty("chkMotivationAnnexIII.text")); // NOI18N
        chkMotivationAnnexIII.setName("chkMotivationAnnexIII"); // NOI18N

        chkMotivationNatRedList.setText(p.getProperty("chkMotivationNatRedList.text")); // NOI18N
        chkMotivationNatRedList.setName("chkMotivationNatRedList"); // NOI18N

        chkMotivationEndemics.setText(p.getProperty("chkMotivationEndemics.text")); // NOI18N
        chkMotivationEndemics.setName("chkMotivationEndemics"); // NOI18N

        chkMotivationIntConv.setText(p.getProperty("chkMotivationIntConv.text")); // NOI18N
        chkMotivationIntConv.setName("chkMotivationIntConv"); // NOI18N

        chkMotivationOtherReason.setText(p.getProperty("chkMotivationOtherReason.text")); // NOI18N
                ...
                .addGroup(jPanel6Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel6Layout.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(Alignment.LEADING)
                                    .addComponent(chkMotivationAnnexI, GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                                    .addComponent(chkMotivationAnnexIII)
                                    .addComponent(chkMotivationEndemics)
                                    .addComponent(chkMotivationAnnexII, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE)
        ...
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(Alignment.LEADING)
                .addGroup(jPanel6Layout.createSequentialGroup()
                    .addComponent(jLabel6)
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addComponent(chkMotivationAnnexI)
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addComponent(chkMotivationAnnexII)
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addComponent(chkMotivationAnnexIII)
                    .addPreferredGap(ComponentPlacement.UNRELATED)
                    .addComponent(chkMotivationEndemics)
        ...
        jPanel6.getAccessibleContext().setAccessibleName(p.getProperty("jPanel6.AccessibleContext.accessibleName")); // NOI18N

        //jLabel5.setIcon(new ImageIcon(p.getProperty("jLabel5.icon")); // NOI18N
        jLabel5.setIcon(SDF_Util.getIconForLabel(p, "jLabel5.icon", SDF_ManagerApp.getMode()));
    ...
    private boolean isSizeOK(String maxArea, String minArea) {
        ...
        try {
          ...
          //e.printStackTrace();
            EditorOtherSpeciesEmerald.log.error("Error Message::" + e.getMessage());
        }
        return sizeOK;
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) { //GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (this.txtName.getText() != null && !("").equals(this.txtName.getText()) && this.txtName.getText().length() > 128) {
           ...
           EditorOtherSpeciesEmerald.log.error("The group field is mandatory.");
           javax.swing.JOptionPane.showMessageDialog(this, "Please, specify a group.");
            ...
            EditorOtherSpeciesEmerald.log.error("Maximum Size field is not a number..");
            ...
            EditorOtherSpeciesEmerald.log.error("Minimum Size field is not a number.");
            ...
            EditorOtherSpeciesEmerald.log.error("The minimum size is bigger than maximum size.");
            javax.swing.JOptionPane.showMessageDialog(this, "Please, Check the size. The minimum size is bigger than maximum size.");
        } else {
            this.saveSpecies();
            EditorOtherSpeciesEmerald.log.info("Species saved.");
    ...
    private javax.swing.JCheckBox chkMotivationAnnexI;
    private javax.swing.JCheckBox chkMotivationAnnexII;
