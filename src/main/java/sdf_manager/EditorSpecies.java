...
public class EditorSpecies extends javax.swing.JFrame {
   ...
   private void populateSpeciesGroup() {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/EditorSpecies.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        jLabel4.setText(p.getProperty(jLabel4Prop)); // NOI18N
        ...
        lbAltSpeciesName.setText(p.getProperty("lbAltSpeciesName.text")); // NOI18N
        lbAltSpeciesName.setName("lbAltSpeciesName"); // NOI18N

        txAltSpeciesName.setEditable(false);
        txAltSpeciesName.setText(p.getProperty("txAltSpeciesName.text")); // NOI18N
        ...
        lbHdSpeciesName.setText(p.getProperty(lbHdSpeciesNameTextProperty)); // NOI18N
        lbHdSpeciesName.setName("lbHdSpeciesName"); // NOI18N

        txHdSpeciesName.setEditable(false);
        txHdSpeciesName.setText(p.getProperty("txHdSpeciesName.text")); // NOI18N
        ...
        jLabel13.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        ...
        jLabel2.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        jLabel2.setText(p.getProperty("jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N

        jLabel14.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        ...
        jLabel15.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        jLabel15.setText(p.getProperty("jLabel15.text")); // NOI18N
        jLabel15.setName("jLabel15"); // NOI18N

        cmbUnit.setName("cmbUnit"); // NOI18N

        jLabel16.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        ...
        jLabel7.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        ...
        jLabel8.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        ...
        jLabel9.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        jLabel9.setText(p.getProperty("jLabel9.text")); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N

        jLabel10.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
        ...
        jLabel11.setIcon(new ImageIcon(p.getProperty("jLabel7.icon"))); // NOI18N
