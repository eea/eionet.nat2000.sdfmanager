...
public class ProgressDialogAppOpen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/ProgressDialogAppOpen.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        imageLabel.setIcon(SDF_Util.getIconForLabel(p, "imageLabel.icon", SDF_ManagerApp.getMode()));
