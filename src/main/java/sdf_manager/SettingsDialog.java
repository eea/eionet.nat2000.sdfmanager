...
public class SettingsDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        try {
            p.load(getClass().getResourceAsStream("resources/SettingsDialog.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }

        // JButton btnSave = new JButton();
        btnSave.setText(p.getProperty("btnSave.text"));

        rdbtnEmerald.setText(p.getProperty("lblEmerald.text"));
        rdbtnNatura.setText(p.getProperty("lblNatura2000.text"));
        ...
        lblDatabaseHost.setText(p.getProperty("lblDatabaseHost.text"));
        ...
        appTitleLabel.setText(p.getProperty("appTitleLabel.text")); // NOI18N
        ...
        btnCancel.setText(p.getProperty("btnCancel.text"));
