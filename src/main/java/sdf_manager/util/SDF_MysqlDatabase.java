...
public class SDF_MysqlDatabase {
    ...
    public static String createOrUpdateDatabaseTables(Connection con, boolean schemaExists, ProgressDialog dialog)
        ...
        try {
            ...
            // release 4.3.6 updates
            if ( !isReleaseDBUpdatesExist(con, "4.3.6")) {
                logD(dialog, "Performing release 4.3.6 updates");
                populateReleaseDBUpdates(con, "4.3.6", "8");
                populateRefTablesInFolder(con, "updates" + File.separator + "4.3.6", dialog);
                logD(dialog, "Release 4.3.6 updates done");
                updateVersionDone(con, "4.3.6");
            }

            // release 4.3.7 updates
            if ( isEmeraldMode() &&!isReleaseDBUpdatesExist(con, "4.3.7")) {
                logD(dialog, "Performing release 4.3.7 updates");
                populateReleaseDBUpdates(con, "4.3.7", "9");
                populateRefTablesInFolder(con, "updates" + File.separator + "4.3.7", dialog);
                logD(dialog, "Release 4.3.7 updates done");
                updateVersionDone(con, "4.3.7");
            }
            ...
            // release 4.4.3 updates
            if (!isEmeraldMode() && !isReleaseDBUpdatesExist(con, "4.4.3")) {
                logD(dialog, "Performing release 4.4.3 updates");
                populateReleaseDBUpdates(con, "4.4.3", "12");
                populateRefTablesInFolder(con, "updates" + File.separator + "4.4.3", dialog);
                logD(dialog, "Release 4.4.3 updates done");
                updateVersionDone(con, "4.4.3");
            }

            if (!isEmeraldMode() && !isReleaseDBUpdatesExist(con, "4.4.4")) {
                logD(dialog, "Performing release 4.4.4 updates");
                populateReleaseDBUpdates(con, "4.4.4", "13");
                populateRefTablesInFolder(con, "updates" + File.separator + "4.4.4", dialog);
