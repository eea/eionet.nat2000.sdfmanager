            ...
            <xsl:when test="string(ecologicalInformation/species)">
              ...
              <table class="SDFtable3rd WholeWidth">
                ...
                <tr>
                  ...
                  <th class="DivisorTop DivisorRight" width="5%">&#160;</th>
                  <th class="DivisorTop DivisorRight" width="5%">C|R|V|P</th>
                  <th class="DivisorTop DivisorRight" width="5%">&#160;</th>
                  <th class="DivisorTop DivisorRight" width="7.5%">Pop.</th>
                  <th class="DivisorTop DivisorRight" width="7.5%">Cons.</th>
                  <th class="DivisorTop DivisorRight" width="7.5%">Isol.</th>
                  <th class="DivisorTop DivisorRight" width="7.5%">Glob.</th>
                </tr>
